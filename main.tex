...
Table~\ref{tab:robust} reports suite status from a selected
\texttt{robustness\_metrics} artifact when present; otherwise rows are
\texttt{NOT RUN} (the offline release gate does not currently select a
robustness artifact).
